        ...
        <div className="min-h-screen bg-white">
            ...
            >
                ...
                <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center text-center px-4">
                    <h1 className="text-2xl sm:text-5xl md:text-6xl font-bold tracking-wide font-['Playfair_Display'] mb-4 typing-effect">
                        HEAVEN INDUSTRIAL PARK
                        </h1>

                    <p className="text-lg sm:text-xl md:text-2xl font-light mb-6 opacity-0 animate-fade-up animation-delay-500">

                        Get Comfortable Room Feel The Comfort. <br />
                        <span className="flex justify-center items-center gap-2 mt-2 text-lg font-medium opacity-0 animate-fade-up animation-delay-700">
                            <FaMapMarkerAlt /> Nr. Balaram Palanpur, Gujarat  <FaRegClock /> Completed
                        </span>
                    </p>
            ...
            >
                ...
                <div className="max-w-5xl mx-auto" >
                    ...
                    <h2 className={`text-3xl sm:text-4xl md:text-5xl font-bold mb-4 tracking-tight font-['Playfair_Display'] typing-effect ${aboutInView ? 'inline-block' : 'hidden'
                        ...
                        <span className="text-red-700">Heaven Industrial Park</span>
                    </h2>
                    ...
                    <p className={`text-base md:text-lg font-light leading-relaxed max-w-3xl mx-auto text-gray-600 transition-opacity duration-700 delay-500 ${aboutInView ? 'opacity-100' : 'opacity-0'
                        ...
                        Heaven Group Is A Premier Leader In Commercial Real Estate Development And Project Management, Dedicated To Transforming Business Environments Into Innovative And Functional Spaces. Our Commitment To Excellence And Visionary Approach Ensures That Every Project We Undertake Not Only Meets But Exceeds Our Clients' Expectations.
                    </p>

                    <div className="mt-10 flex justify-center gap-8 flex-wrap">
                        {[
                            { icon: <FaHome className="text-red-600 text-2xl" />, text: "Commercial" },
                            { icon: <FaMapMarkerAlt className="text-red-600 text-2xl" />, text: "Balaram Nr. Palanpur, Gujarat" },
                            { icon: <FaRegClock className="text-red-600 text-2xl" />, text: "Completed Project" }
                        ].map((item, idx) => (
                            <div
                                key={idx}
                ...
                <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-start">
                    ...
                    <div className="text-left space-y-6">
                        ...
                        <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                            Club Heaven Balaram,<br />
                            Abu Highway,<br />
                            Dist: Banaskantha, Gujarat, India.
                        </p>

                        <a
                            href="https://maps.app.goo.gl/hAHGEXZ3Gk2M3ezm8"
                            target="_blank"
                    ...
                    <div className="rounded-xl overflow-hidden shadow-lg border border-gray-300 transition-all duration-700 hover:scale-[1.01]">
                        <iframe
                            title="Heaven Industrial Park"
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3637.207109467253!2d72.49783477513219!3d24.269495578319805!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395cc3fe841480ff%3A0x731a86663c97da4e!2sClub%20Heaven!5e0!3m2!1sen!2sin!4v1751254814646!5m2!1sen!2sin"
                            width="100%"
                            height="350"
                            allowFullScreen=""
                            loading="lazy"
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    >
                        ...
                        <p className="mt-6 text-gray-600 text-lg">
                            Or email us directly at <span className="text-red-600 font-semibold">contact@clubheaven.com</span>
                        </p>
                    </div>
                </div>
            </section>
